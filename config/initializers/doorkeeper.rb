...
Doorkeeper.configure do
  ...
  # Mastodon互換: クライアントはリフレッシュトークンフローを実装していないため、
  # トークンを事実上無期限にする
  access_token_expires_in 100.years
  ...
  optional_scopes :read, :write, :follow, :push, :admin,
                 ...
                 'read:follows', 'read:lists', 'read:mutes', 'read:notifications', 'read:search',
                 'read:statuses', 'write:accounts', 'write:blocks', 'write:bookmarks', 'write:favourites',
                 'write:filters', 'write:follows', 'write:lists', 'write:media', 'write:mutes',
                 'write:notifications', 'write:reports', 'write:statuses', 'admin:read', 'admin:write'
